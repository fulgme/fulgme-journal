...
ABOUT = f"""
    ...
    <p>Forum for United Leaders in Graduate Medical Education. A peer-reviewed, open-access journal
    advancing research, authorship, scholarship, innovation, and professional development in graduate
    medical education leaders.</p>
