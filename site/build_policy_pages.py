...
BOARD = f"""
    ...
    <h2>Board members</h2>
    <table class="facts">
      <tr><th>Barbara Gohre, BSHA, CHPM, CLSSBB</th>
          <td>President and Founder<br>Phoenix Children&rsquo;s; FULGME</td></tr>
      <tr><th>Kelly Conlon, MHA</th>
          <td>Vice President, Co-Chair, and Editor in Chief<br>Northwell Health, Eastern Region; FULGME</td></tr>
      <tr><th>Stephanie Bowen</th>
          <td>Associate Editor<br>FULGME</td></tr>
      <tr><th>Crys S. Curkendoll-Draconi, PMP, AA</th>
          <td>Board Member<br>Program Manager, ONMM Residency and Osteopathic Recognition;
          Cleveland Clinic South Pointe Hospital</td></tr>
      <tr><th>Juanita Braxton, PhD</th>
          <td>Board Member<br>Imani Consulting, independent</td></tr>
    </table>
